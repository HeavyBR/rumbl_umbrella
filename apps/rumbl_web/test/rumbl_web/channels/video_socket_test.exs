defmodule RumblWeb.Channels.VideoChannelTest do
  ...
  setup do
    user = Rumbl.UserFixtures.user_fixture(name: "Gary")
    video = Rumbl.MultimediaFixtures.video_fixture(user, title: "Testing")
  ...
  test "new annotations triggers InfoSys", %{socket: socket, video: vid} do
    Rumbl.UserFixtures.user_fixture(
      username: "wolfram",
    ...
    assert_broadcast "new_annotation", %{body: "2", at: 123}, 10000
  end
end
